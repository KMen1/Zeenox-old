...
{
    public static Task<MessageComponent> MakeNowPlayingButtons(bool canGoBack, bool canGoForward, bool isPlaying)
    {
        return Task.Run(() =>
        {
            var buttons = new ComponentBuilder()
                ...
                .WithButton("Leállítás", "stop", emote: new Emoji("⏹"), row: 0)
