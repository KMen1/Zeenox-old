...
{
    public CrashGame(SocketGuildUser user, IUserMessage message, int bet, double crashPoint)
    {
    ...
    public async Task StopAsync()
    {
        ...
        await Message
            ...
            .ConfigureAwait(false);
        OnGameEnded(
            new GameEndedEventArgs(Id, User, Bet, Profit, $"Crash: {Multiplier:0.0}x", false)
        );
    }
